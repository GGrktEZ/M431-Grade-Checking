...
public interface IteachersService
{
    ...
    /// <summary>
    /// Adds a teachers to the database via the RegisterExistingTeacherDto .
    /// </summary>
    /// <param name="RegisterExistingTeacherDto ">A Dto to be added to the database. </param>
    /// <returns> The id of the newly created teachers. </returns>
    int Addteachers(RegisterExistingTeacherDto  teachers);
    /// <summary>
    /// Updates a teachers of the database via the UpdateteachersDto.
    /// </summary>
    /// <param name="RegisterExistingTeacherDto ">The Dto to be changed in the database. </param>
